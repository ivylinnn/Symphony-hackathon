...
export const VARIATION_PLANNER_EXTRA = 330;
/** Strategy 卡（Vary 折叠态）：方向 + 理由 + 折叠行 + 数量 + 生成入口。 */
const STRATEGY_NODE_HEIGHT = 300;
/** Vary 设置展开后 strategy 卡追加的高度。 */
export const STRATEGY_VARY_EXTRA = 88;
